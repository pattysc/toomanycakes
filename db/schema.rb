...
ActiveRecord::Schema.define(version: 20170116005206) do
  ...
  create_table "meal_groups", force: :cascade do |t|
    t.integer "meal_id"
    t.integer "group_id"
    t.index ["group_id"], name: "index_meal_groups_on_group_id", using: :btree
    t.index ["meal_id"], name: "index_meal_groups_on_meal_id", using: :btree
  end
